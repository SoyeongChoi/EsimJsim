...
public class ReviewAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        mConditionRef = mDatabase.child("review").child(list_itemArrayList.get(position).getAddr());
                            ...
                            new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    if(list_itemArrayList.get(position).getReal_id().equals(ID)){
                                        ...
                                        DatabaseReference myreview = FirebaseDatabase.getInstance().getReference().child("member").child(loginType).child(ID).child("review").child(list_itemArrayList.get(position).getAddr());
